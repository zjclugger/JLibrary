 ...
 */
public class GoodsDetailEditFragment extends BaseGoodsDetailFragment {
   ...
   // private List<BillTypeResult> mBillTypeList = new ArrayList<>();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_goods_detail_edit,
                container, false);
...
/*
        if (mOriginalDetailResult != null) {
            mOriginalDetailResultCache = CommonUtils.copyObject(mOriginalDetailResult);
            initView();
            bindData();
        } else {
            close();
    ...
    private void initView() {
        ...
        mTitleRightView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* String cacheValue = CommonUtils.object2Json(mOriginalDetailResultCache);
                String currentValue = CommonUtils.object2Json(mOriginalDetailResult);
        ...
        mBinding.billUploader.setValueText(mArguments.getString(SellerConstants.Keywords.KEY_ORIGINAL_UPLOADER));
        mBinding.billUploadDate.setValueText(CommonUtils.getDate(mArguments.getString(SellerConstants.Keywords.KEY_ORIGINAL_UPLOAD_DATE)));
     ...
     /*   ViewUtils.setEditTextDigits(mBinding.letvTotalSmall.getEditTextView());
                ...
                DateTimePickerView mStartDatePickerDialog = new DateTimePickerView(getActivity(),
                        new OnTimeSelectListener() {
                            ...
                            public void onTimeSelect(Date date, View v) {
                                mBinding.letvInputDate.getEditTextView().setText(CommonUtils.getDateTime(date,
                                        "yyyy-MM-dd"));
                            }
                        }, DateTimeFormat.YMD);
      ...
      /*  mBillTypePickerView.getBuilder().setSubmitColor(R.color.text_selected);
        ...
        mBillTypePickerView.displayClassicLayout("凭证类型", null, getString(R.string.text_confirm));
       ...
       /* mBinding.setOriginal(mOriginalDetailResult);
        ...
        mDetailsAdapter.setOnItemClickListener(new Monitor.OnItemClickListener() {
            ...
            public void onItemClick(RecyclerView.Adapter adapter, View view, final int position) {
                ...
                mPosition = position;
                mAlertDialog.setMessage(CommonUtils.getString(mContext,R.string.delete_purchase_sale,
                        CommonUtils.getString(mOriginalDetailResult.getDetailList().get(mPosition).getServiceName())))
                        .setCancelable(true)
