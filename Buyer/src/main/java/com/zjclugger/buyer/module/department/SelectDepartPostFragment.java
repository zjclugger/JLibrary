...
public class SelectDepartPostFragment extends BaseFragment {
    ...
    public void initViews() {
        mListView = mView.findViewById(R.id.depart_post_list_view);
        mSearchView = mView.findViewById(R.id.depart_search_view);
        mAllLayout = mView.findViewById(R.id.depart_all_layout);
