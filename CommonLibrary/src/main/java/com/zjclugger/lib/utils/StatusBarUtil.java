...
public class StatusBarUtil {
    ...
    public static void setTranslucentForImageViewInFragment(Activity activity, @IntRange(from = 0
            , to = 255) int statusBarAlpha, View needOffsetView) {
    ...
    /**
     * 设置标题字体颜色为浅色(需要在布局的根元素下增加android:fitsSystemWindows="true")
     *
     * @param activity
     */
    ...
    /**
     * 设置标题字体颜色为深色(需要在布局的根元素下增加android:fitsSystemWindows="true")
     *
     * @param activity
     */
    @TargetApi(Build.VERSION_CODES.M)
    ...
    /**
     * 设置字体颜色(布局的根元素下增加android:fitsSystemWindows="true")
     *
     * @param activity
     * @param isLight  true:黑色 false:白色
     */
    public static void setMode(Activity activity, boolean isLight) {
        if (isLight) {
    ...
    public static void setStatusBarStyle(Activity activity, @ColorRes int statusBarColor,
                                         boolean isLightMode) {
        StatusBarUtil.setColorNoTranslucent(activity,
                activity.getResources().getColor(statusBarColor));
        StatusBarUtil.setMode(activity, isLightMode);
    }
...
/*            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && RomUtils.isMiUIV7OrAbove()) {
    ...
    private static int getStatusBarHeight(Context context) {
        ...
        if (resourceId > 0) {
            ...
            Log.e(TAG, "the resource id is 0 context is " + context);
        }
        return 0;
    }
