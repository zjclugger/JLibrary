...
public class LinearItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public LinearItemDecoration(int span, int leftPadding, int rightPadding, int color,
                                boolean show) {
        mSpanSpace = span;
        mShowLastLine = show;
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent,
        ...
        int count = mShowLastLine ? parent.getAdapter().getItemCount() :
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            mSpanSpace = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, 1f,
        ...
        public Builder setSpan(float pixels) {
            mSpanSpace = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, pixels,
        ...
        public Builder setLeftPadding(float pixelPadding) {
            mLeftPadding = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX,
                    pixelPadding, mResources.getDisplayMetrics());
            return this;
        }
        ...
        public Builder setRightPadding(float pixelPadding) {
            mRightPadding = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX,
                    pixelPadding, mResources.getDisplayMetrics());
            return this;
        }
