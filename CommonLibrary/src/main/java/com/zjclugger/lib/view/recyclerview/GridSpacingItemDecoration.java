...
public class GridSpacingItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public GridSpacingItemDecoration(float gapHorizontalDp, float gapVerticalDp,
                                     float sectionEdgeHPaddingDp, float sectionEdgeVPaddingDp) {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent,
        ...
        if (parent.getLayoutManager() instanceof GridLayoutManager && parent.getAdapter() instanceof BaseSectionQuickAdapter) {
            ...
            BaseSectionQuickAdapter<SectionEntity, BaseViewHolder> adapter =
                    (BaseSectionQuickAdapter) parent.getAdapter();
            if (mAdapter != adapter) {
...
//            Log.w("GridAverageGapItem", "pos=" + position + ",vPos=" + visualPos + "," +
...
//            Log.w("GridAverageGapItem", "section list=" + mSectionList);
    ...
    private void transformGapDefinition(RecyclerView parent, int spanCount) {
        ...
        gapHSizePx = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, gapHorizontalDp
                , displayMetrics);
        gapVSizePx = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, gapVerticalDp,
                displayMetrics);
        sectionEdgeHPaddingPx = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                sectionEdgeHPaddingDp, displayMetrics);
        sectionEdgeVPaddingPx = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                sectionEdgeVPaddingDp, displayMetrics);
