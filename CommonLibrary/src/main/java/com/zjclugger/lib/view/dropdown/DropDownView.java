...
public class DropDownView extends LinearLayout {
    ...
    public DropDownView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        menuSelectedIcon = a.getResourceId(R.styleable.DropDownView_ddv_selected_icon,
                menuSelectedIcon);
    ...
    public void setDropDownView(@NonNull List<String> tabTexts, @NonNull List<View> popupViews,
        ...
        popupMenuViews.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) (CommonUtils.getScreenSize(getContext()).y * menuHeighPercent)));
    ...
    private void addTab(@NonNull List<String> tabTexts, int i) {
        ...
        if (i < tabTexts.size() - 1) {
            ...
            view.setLayoutParams(new LayoutParams(dpTpPx(0.5f),
