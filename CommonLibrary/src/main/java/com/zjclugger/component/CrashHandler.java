package com.zjclugger.component;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public void collectDeviceInfo() {
        try {
            ...
            if (pi != null) {
                ...
                infoList.put("Android Device", Build.MODEL);
                infoList.put("Android Version", Build.VERSION.RELEASE);
            }
    ...
    private String saveCrashInfoToFile(Throwable ex) {
        ...
        try {
            ...
            Log.e(TAG, "an error had occured while writing file the message is " + e.getMessage());
        }
        return null;
    }
}