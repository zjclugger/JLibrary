...
public abstract class BaseBillFragment extends BaseFragment {
    private final static String TAG = "bill";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LiveEventBus.get(FinanceConstants.Keywords.KEY_SEARCH_CONDITION, Bundle.class)
    ...
    public void onResume() {
        ...
        if (!isHidden()) {
            if (mSearchCondition != null && !mSearchCondition.isEmpty()) {
                ...
                mCompanyName = mSearchCondition.getString(FinanceConstants.Keywords.KEY_SEARCH_TEXT,
                        "");
                mStartDate =
                        mSearchCondition.getString(FinanceConstants.Keywords.KEY_SEARCH_START_DATE, "");
                mEntryDate =
                        mSearchCondition.getString(FinanceConstants.Keywords.KEY_SEARCH_ENTRY_DATE, "");
    ...
    public void onStop() {
        super.onStop();
        mBillRecyclerView.setForceTop(false);
    }
    ...
    public void initViews() {
        ...
        //先要初始化Adapter
        mBillRecyclerView.setRefreshLayoutListener(new OnRefreshListener() {
            @Override
